...
For the analyses in this repository, we start with the GRanges files, which contain cell-free DNA fragment information. The code that was used to create the data needed to rebuild the analysis is saved in `code`.
...
- Figure 3: [HTML](../docs/Figure3.html), [Code](../analysis/Figure3.Rmd)
  ...
  - E,F: [HTML](../docs/Figure3EF.html), [Code](../analysis/Figure3EF.Rmd), figures in HTML **[old version, need to update]** 
...
- Supp. Fig. 9: [HTML](../docs/Supplementary_Figure9.html), [Code](../analysis/Supplementary_Figure9.Rmd), figures in HTML **[old version, need to update]**
- Supp. Fig. 10: [HTML](../docs/Supplementary_Figure10.html), [Code](../analysis/Supplementary_Figure10.Rmd), [JPG](../docs/figure/Supplementary_Fig_10.jpg) **[old version, need to update]**
